...
@Controller
public class ZoekArtikelOpNaamController {
...
@RequestMapping(value = "/zoekartikelopnaam", method = RequestMethod.GET)
    public String zoekArtikelopNaamGet() {
        return "/zoekartikelopnaam";
    }
