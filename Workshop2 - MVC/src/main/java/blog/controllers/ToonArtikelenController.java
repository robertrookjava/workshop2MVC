...
@Controller
public class ToonArtikelenController {
...
@RequestMapping(value = "answers/toonartikelen", method = RequestMethod.GET)
    public String toonArtikelenGet(Model model, HttpServletRequest request ) {
