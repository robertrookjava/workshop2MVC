...
@Controller
public class ZoekArtikelOpIdController {
...
@RequestMapping(value = "/zoekartikelopid", method = RequestMethod.GET)
    public String zoekArtikelopIdGet() {
        return "/zoekartikelopid";
    }
    ...
    public String zoekArtikelOpIdPost(Model model, HttpServletRequest request) throws Exception {
        ...
        Artikel artikel= artikelService.read(Integer.parseInt(idArtikel));
