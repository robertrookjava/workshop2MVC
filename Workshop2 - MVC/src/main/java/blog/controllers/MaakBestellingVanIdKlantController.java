...
@Controller
public class MaakBestellingVanIdKlantController {
...
@RequestMapping(value = "/maaknieuwebestellingvanidklant", method = RequestMethod.GET)
    public String maakBestellingVanIdKlantGet() {
        return "maaknieuwebestellingvanidklant";
    }
    ...
    public String maakBestellingVanIdKlantPost(Model model, HttpServletRequest request){
        ...
        int idBestelling = bestellingService.create(Integer.parseInt(idKlant), ingelogdeGebruiker.getIdAccountIngelogdeGebruiker());
        ...
        return "answers/idbestellingaangemaakt";
