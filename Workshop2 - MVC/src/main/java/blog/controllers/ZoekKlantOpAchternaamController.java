...
@Controller
public class ZoekKlantOpAchternaamController {
...
@RequestMapping(value = "/zoekklantopachternaam", method = RequestMethod.GET)
    public String zoekKlantopAchternaamGet() {
        return "/zoekklantopachternaam";
    }
    ...
    public String zoekKlantopAchternaamPost(Model model, HttpServletRequest request) throws Exception {
        ...
        System.out.println("robert1: achternaam ="+ achternaam );
        
        
        //klantService.create(voornaam, achternaam, tussenvoegsel, telefoonnummer, emailadres);
//        List<Artikel> artikelList = artikelService.read(naam);
//        model.addAttribute("artikelList", artikelList);

        List<Klant> klantList = klantService.read(achternaam);
