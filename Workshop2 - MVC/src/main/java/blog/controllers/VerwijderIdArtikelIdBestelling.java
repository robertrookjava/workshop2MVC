...
@Controller
public class VerwijderIdArtikelIdBestelling {
...
@RequestMapping(value = "/verwijderidartikelidbestelling", method = RequestMethod.GET)
    public String verwijderIdArtikelIdBestellingGet() {
    ...
    public String verwijderIdArtikelIdBestellingPost(Model model, HttpServletRequest request) throws Exception {
        ...
        bestelArtikelService.delete(Integer.parseInt(idBestelling), Integer.parseInt(idArtikel), idAccount);
