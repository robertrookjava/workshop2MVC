...
@Controller
public class AanmakenKlantController {
...
@RequestMapping(value = "/aanmakenklant", method = RequestMethod.GET)
    public String aanmakenKlantGet() {
        return "/aanmakenklant";
    }
    ...
    public String aanmakenKlantPost(Model model, HttpServletRequest request){
        ...
        System.out.println("robert1: voornaam = "+voornaam );
        System.out.println("robert2: achternaam = "+achternaam );
        System.out.println("robert3: tussenvoegsel = "+tussenvoegsel);
        System.out.println("robert4: telefoonnummer = "+telefoonnummer );
        System.out.println("robert5: emmailadres = "+ emailadres );
