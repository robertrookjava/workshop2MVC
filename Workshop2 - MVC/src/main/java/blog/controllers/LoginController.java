...
@RequestMapping("/")
    ...
    public String loginPage(@Valid LoginForm loginForm, BindingResult bindingResult, HttpSession httpSession) {
        ...
        Account account = userService.account(loginForm.getUsername(), loginForm.getPassword());
