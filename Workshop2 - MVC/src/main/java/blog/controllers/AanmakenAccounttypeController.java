...
@Controller
public class AanmakenAccounttypeController {
...
@RequestMapping(value = "/aanmakenaccounttype", method = RequestMethod.GET)
    public String aanmakenAccounttypeGet() {
        return "/aanmakenaccounttype";
    }

    @RequestMapping(value = "/aanmakenaccounttype", method = RequestMethod.POST)
    //ublic String aanmakenAccounttypePost(Model model, HttpServletRequest request) {
    public String aanmakenAccounttypePost(Model model, HttpServletRequest request) {
        System.out.println("Robert1");
        String id = request.getParameter("id");
        String type = request.getParameter("type");
        
        
        System.out.println("Robert2: idString = "+id);
        System.out.println("Robert3: type = "+type);
